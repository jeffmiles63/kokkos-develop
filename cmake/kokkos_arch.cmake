...
FUNCTION(KOKKOS_ARCH_OPTION SUFFIX DOCSTRING)
  ...
  KOKKOS_OPTION(ARCH_${SUFFIX} OFF BOOL ${DOCSTRING} DEFAULT)
  ...
  SET(KOKKOS_ENABLE_ARCH_${SUFFIX} ${KOKKOS_ENABLE_ARCH_${SUFFIX}} PARENT_SCOPE)
ENDFUNCTION()
...
KOKKOS_OPTION(ARCH "" STRING "Optimize for specific host architecture. Options are: ${KOKKOS_INTERNAL_ARCH_DOCSTR}" DEFAULT)
...
#------------------------------- KOKKOS_CUDA_COMPILE_OPTIONS ---------------------------
#clear anything that might be in the cache
GLOBAL_SET(KOKKOS_CUDA_COMPILE_OPTIONS "")
# Construct the Makefile options
IF (KOKKOS_ENABLE_CUDA_LAMBDA)
  IF(KOKKOS_CXX_COMPILER_ID STREQUAL NVIDIA)
    GLOBAL_APPEND(KOKKOS_CUDA_COMPILE_OPTIONS "-expt-extended-lambda")
  ENDIF()
ENDIF()

IF (KOKKOS_CXX_COMPILER_ID STREQUAL Clang)
  SET(CUDA_ARCH_FLAG "--cuda-gpu-arch")
  GLOBAL_APPEND(KOKKOS_CUDA_COMPILE_OPTIONS -x cuda)
  IF (KOKKOS_ENABLE_CUDA)
     SET(KOKKOS_IMPL_CUDA_CLANG_WORKAROUND ON CACHE BOOL "enable CUDA Clang workarounds" FORCE)
     IF (DEFINED KOKKOS_CUDA_DIR)
        GLOBAL_APPEND(KOKKOS_CUDA_COMPILE_OPTIONS --cuda-path=${KOKKOS_CUDA_DIR})
     ENDIF()
  ENDIF()
...
IF (KOKKOS_CXX_COMPILER_ID STREQUAL NVIDIA)
  ...
  IF (KOKKOS_ENABLE_DEBUG OR _UPPERCASE_CMAKE_BUILD_TYPE STREQUAL "DEBUG")
    GLOBAL_APPEND(KOKKOS_CUDA_COMPILE_OPTIONS -lineinfo)
  ENDIF()
...
IF(KOKKOS_ARCH_${ARCH})
  ...
  GLOBAL_APPEND(KOKKOS_CUDA_COMPILE_OPTIONS "${CUDA_ARCH_FLAG}=${FLAG}")

  LIST(APPEND NEW_CUDA_LINK_OPTIONS ${KOKKOS_LINK_OPTIONS})
  LIST(APPEND NEW_CUDA_LINK_OPTIONS "${CUDA_ARCH_FLAG}=${FLAG}")
  GLOBAL_SET(KOKKOS_LINK_OPTIONS ${NEW_CUDA_LINK_OPTIONS})
ENDIF()
ENDFUNCTION()
